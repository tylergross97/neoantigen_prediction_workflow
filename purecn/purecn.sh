...
#SBATCH --mem=258G
#SBATCH --time=3:00:00
#SBATCH --output=/projects/academic/rpili/Jonathan_Lovell_project/purecn/slurm-%j.out
#SBATCH --error=/projects/academic/rpili/Jonathan_Lovell_project/purecn/slurm-%j.err
...
export NXF_WORK=/vscratch/grp-rpili/neoantigen/purecn
