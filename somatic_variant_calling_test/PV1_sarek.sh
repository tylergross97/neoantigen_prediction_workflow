...
#SBATCH --output=/projects/academic/rpili/Jonathan_Lovell_project/somatic_variant_calling_test/PV1_sarek-%j.out
#SBATCH --error=/projects/academic/rpili/Jonathan_Lovell_project/somatic_variant_calling_test/PV1_sarek-%j.err
...
export NXF_WORK=/vscratch/grp-rpili/neoantigen/PV1_sarek
...
# Run nf-core/sarek
NXF_VER=24.0.4 nextflow run nf-core/sarek -r 3.5.1 \
    -profile singularity \
    -c custom_mutect2_paired.config \
    --input /projects/academic/rpili/Jonathan_Lovell_project/data/sample_sheets/PV1_sarek.csv \
    --outdir /projects/academic/rpili/Jonathan_Lovell_project/results/PV1/PV1_sarek \
    --genome GATK.GRCh38 \
    --tools strelka,mutect2,cnvkit,vep \
    --max_memory '258.GB' \
    --max_cpus 16 \
    --wes \
    --intervals /projects/academic/rpili/Jonathan_Lovell_project/data/hg38_Twist_ILMN_Exome_2.0_Plus_Panel_annotated.sorted.bed \
    -work-dir /vscratch/grp-rpili/neoantigen_prediction/PV1_sarek \
    -resume
