#!/bin/bash
#SBATCH --job-name="neoantigen_prediction_test_rna_seq"
...
export NXF_WORK=/projects/academic/rpili/tgross2/tmp/nextflow_work
...
nextflow run nf-core/rnaseq -r dev \
    --input /projects/academic/rpili/Jonathan_Lovell_project/fastq/sample_sheet_rna.csv \
    --aligner star_salmon \
    ...
    --max_memory '258.GB' \
    --max_time '36.h' \
    --outdir /projects/academic/rpili/Jonathan_Lovell_project/transcript_quant_test/results_rna_seq \
    -profile singularity \
    -work-dir /projects/academic/rpili/tgross2/tmp/nextflow_work \
